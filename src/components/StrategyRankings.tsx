...
const strategies: Strategy[] = [
  { name: "RSI Strategy", return: "+12.5%", color: "bg-blue-500" },
  { name: "Ichimoku Cloud", return: "+9.8%", color: "bg-indigo-500" },
  { name: "Moving Average Crossover", return: "+8.2%", color: "bg-green-500" },
  { name: "Bollinger Bands", return: "+5.7%", color: "bg-amber-500" },
  { name: "MACD Strategy", return: "+3.2%", color: "bg-orange-500" },
];
