...
export function TradingSettings() {
  ...
  const handleSubmit = (values: NotificationPreferences) => {
    if (!isPro) {
      toast.error("This feature is only available for Pro users. Please upgrade to Pro to access notification settings.");
      return;
    }
  ...
  const handleSwitchChange = (field: any, value: boolean) => {
    if (!isPro) {
      toast.error("This feature is only available for Pro users. Please upgrade to Pro to enable notifications.");
      return;
    }
  ...
  const renderSignalNotificationTypes = () => {
    ...
    const handleSignalSwitchChange = (value: boolean, signalType: string) => {
      if (!isPro) {
        toast.error("This feature is only available for Pro users. Please upgrade to Pro.");
        return;
      }
      console.log(`${signalType} notifications:`, value);
      // Here you would normally save the preference
    };
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Switch 
            ...
            onCheckedChange={(value) => handleSignalSwitchChange(value, "Entry")}
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch 
            defaultChecked={false} 
            onCheckedChange={(value) => handleSignalSwitchChange(value, "Exit")}
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch 
            defaultChecked={false} 
            onCheckedChange={(value) => handleSignalSwitchChange(value, "Stop Loss")}
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch 
            defaultChecked={false} 
            onCheckedChange={(value) => handleSignalSwitchChange(value, "Take Profit")}
          />
        </div>
      </div>
    );
    ...
    <div className="space-y-12">
      ...
      {isPro && (
        <div>
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Choose which types of signals you want to receive
          </p>
          
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Notification Types</CardTitle>
              <CardDescription>Customize which trading events trigger notifications</CardDescription>
            </CardHeader>
            <CardContent>
