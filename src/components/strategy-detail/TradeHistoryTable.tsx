...
export const TradeHistoryTable = ({
  ...
  return <div className="overflow-x-auto">
      <Table>
        ...
        <TableBody>
          {displayTrades.length > 0 ? displayTrades.map((trade, index) => {
          ...
          return <TableRow key={index} className="cursor-pointer hover:bg-muted/60" onClick={() => handleRowClick(trade)}>
                  <TableCell>
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        {trade.targetAsset && <TooltipContent side="top" className="max-w-xs">
                  ...
                  <TableCell>
                    {!isBuy && trade.profit && <div className="flex flex-col">
                    ...
                    {isBuy && <span className="text-gray-400">—</span>}
                  </TableCell>
                </TableRow>;
        }) : <TableRow>
      ...
      {showViewAllButton && <div className="mt-4 flex justify-center">
          <Button variant="outline" onClick={onViewAllClick} className="w-full sm:w-auto px-[24px] py-[16px]">
